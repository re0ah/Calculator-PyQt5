...
class MainWindow(QtWidgets.QMainWindow):
	def __init__(self):
		...
		self.window = uic.loadUi(os.path.join("ui", "mainwindow.ui"))
		self.window.show()
		self.assignWidgets()
	...
	def assignWidgets(self):
		...
		self.window.pushbtn_calc.clicked.connect(self.calc)
	...
	def entry_line_last_symbol(self):
		"""Возвращает последний символ из поля вода. Если строка пустая, возвращает '\0'"""
